...
<body>
    ...
    <div class="shop-content" style="padding-top: 50px; min-height: 1000px;">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    ...
                    <div class="content-header container d-flex justify-content-between">
                        ...
                        <div class="row">
                            ...
                            <p class="content-header__code-number"><?php 
                                echo $order["code"];
                            ?></p>
                        </div>
                    </div>
                    ...
                    <div class="content-content container">
                        <h2 class="content-content__header">ĐỊA CHỈ NHẬN HÀNG</h2>
                        <p class="content-content__name">Nguyễn Đức Hạnh</p>
                        <p class="content-content__phone-number">(+84) 387697588</p>
                        <p class="content-content__address">Số 03 khu 103 Hàng Dưa, Hà Cầu, Hà Đông Hà Nội</p>
                    </div>
                    <hr>
                    <div class="bill-content container">
                        <div class="item row">
                            <!-- Start order element -->
                            <?php 
                                foreach ((array)$order["details"] as $orderDetail){
                            ?>
                            ...
                            <div class="item-content col-md-9">
                                <span class="item-label">
                                    <?php 
                                        echo $orderDetail["category"];
                                    ?>
                                </span>
                                <a class="item-header"><?php 
                                ...
                                <div class="item-detail-quantity">
                                    ...
                                    ?> - Thành tiền: <?php
                                        echo (int)$orderDetail["quantity"] * (int)$orderDetail["price"];
                                    ?></span>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 detail-content-col">Tổng tiền hàng</div>
                            <div class="col-md-4 detail-content-col"><?php
                                        echo (int)$orderDetail["quantity"] * (int)$orderDetail["price"];
                                    ?></div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 detail-content-col">Phí vận chuyển</div>
                            <div class="col-md-4 detail-content-col">40.000₫</div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 detail-content-col">Voucher: Miễn phi giao hàng trong nội thành hà nội</div>
                            <div class="col-md-4 detail-content-col">-40.000₫</div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 detail-content-col">Tổng số tiền </div>
                            <div class="col-md-4 detail-content-col2"><?php
                                        echo (int)$orderDetail["quantity"] * (int)$orderDetail["price"] - 40000;
                                    ?></div>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 detail-content-col">Phương thức thanh toán</div>
